...
[Unit]
Description=pod migration operator
Documentation=https://github.com/SSU-DCN/podmigration-operator
ConditionPathExists=$SSU_DCN_POD_MIGRATION_PKG_DIR/main.go
...
ExecStart=$GOROOT/bin/go run $SSU_DCN_POD_MIGRATION_PKG_DIR/main.go
WorkingDirectory=$SSU_DCN_POD_MIGRATION_PKG_DIR
